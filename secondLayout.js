...
let draw = () => {
  ...
  // }
// if(score===1){
//     itemMoneyArr[0].drawPickedItem()
// // }
// // if(score===2){
//     itemMoneyArr[0].drawPickedItem()
//     itemMoneyArr[1].drawPickedItem()
// }
// if(score===3){
    // itemMoneyArr[0].drawPickedItem()
    // itemMoneyArr[1].drawPickedItem()
    // itemMoneyArr[2].drawPickedItem()
  drawItemMoney(score)
  drawItemLove(score)
  drawItemHealth(score)
  drawItemLeisure(score)
// }

    // itemMoneyArr[0].drawPickedItem()
    // itemMoneyArr[1].drawPickedItem()
    // itemMoneyArr[2].drawPickedItem()
    // itemMoneyArr[3].drawPickedItem()
  drawMiddleAndAxis()
  //drawItemMoney()
  // drawItemLove()
  // drawItemHealth()
